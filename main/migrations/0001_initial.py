# Generated by Django 3.2.6 on 2021-11-21 17:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.DateField(default=datetime.datetime(2021, 11, 21, 17, 25, 58, 840889, tzinfo=utc), verbose_name='Дата генерации')),
                ...
                ('passport', models.CharField(blank=True, default='Данных нет', max_length=20, null=True, verbose_name='Паспорт')),
                ('email', models.EmailField(blank=True, default='Данных нет', max_length=50, null=True, verbose_name='Почта')),
                ('phone', models.CharField(blank=True, default='Данных нет', max_length=20, null=True, verbose_name='Телефон')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_generated_code', models.DateTimeField(auto_now_add=True, verbose_name='Дата генерации кода')),
